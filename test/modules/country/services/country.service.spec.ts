...
describe('CountryService', () => {
    ...
    //         );
    //         const fileContent = fs.readFileSync(countriesFilePath, 'utf8');
    //         countriesData = JSON.parse(fileContent);
    //     });
    //
    //     const getTestData = (): CountryCreateRequestDto[] => {
    ...
    //                 domain: country.unicode || 'id',
    //                 fipsCode: country?.unicode || 'ID',
    //                 numericCode: country?.dialCode || '360',
    //                 phoneCode: country?.dialCode || ['62'],
    //                 geo: country.geo,
    ...
    //     };
    //
    //     it('should create many countries', async () => {
    //         const dto = getTestData();
    //
    ...
    //     });
    //
    //     it('should create many countries with session', async () => {
    //         const dto = getTestData();
    //
    //         const entity = dto.map(
    //             ({
